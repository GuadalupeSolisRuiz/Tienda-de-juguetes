...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2026 a las 21:53:10
...
INSERT INTO `carrito` (`id_carrito`, `id_usuario`, `fecha_entrada`) VALUES
(1, 1, '2026-05-04');
...
INSERT INTO `detalle_carrito` (`id_detalle_carrito`, `cantidad_carrito`, `id_productos`, `id_carrito`) VALUES
(1, 1, 1, 1);
...
INSERT INTO `factura` (`id_factura`, `id_usuario`, `fecha_factura`, `subtotal_factura`, `impuestos`, `total_factura`, `estado_factura`) VALUES
(1, 1, '2026-05-04 16:48:03', 168.00, 10.00, 178.00, 'Pagada');

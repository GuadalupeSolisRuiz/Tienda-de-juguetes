...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2026 a las 11:06:43
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `correo`, `contraseña`, `telefono`, `fecha_registro`, `id_rol`) VALUES
(1, 'Alexis', 'Gonzalez', 'alex@mail.com', '$2y$10$kGqioX9gEady/k0exKBKFezyD7fb63RiH7C68DOAP/Y1AVGa3/dWy', '5577374655', '2026-06-01', 3),
(2, 'Vanesa', 'Garcia', 'vane@mail.com', '$2y$10$N5cykhe.HJXgBFnKPnKsBeNDKiHiHcf7WTvV.w9cbvsiSN6o8gm2.', '1234567890', '2026-06-01', 1),
(3, 'Edson', 'Quintana', 'edson@mail.com', '$2y$10$3DczX9LsqwHlMhlyJnJeUeQBaex9LvL.fb4xGbLrAozQ9HqFpNCX6', '1234567890', '2026-06-01', 1),
(4, 'Ruben', 'Fuentes', 'ruben@mail.com', '$2y$10$0DETrqXtDyr5XU5WEPsrl./CbowD2Z0tql5EErNVbfsGxn4B8xvs2', '1234567890', '2026-06-02', 1);
